...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |----------------------------------------------------------------|
   * |Ctrl   |  A|  S|  D|  F|  G|  H|  J|  K|  L|  ;|  '|Return |Hme |
   * |----------------------------------------------------------------|
...
[_FL] = KEYMAP_ANSI(
  ...
  _______,_______, KC_UP,_______,_______, _______,_______,_______,KC_MS_WH_DOWN, KC_MS_WH_UP,_______, KC_MEDIA_PREV_TRACK, KC_MEDIA_NEXT_TRACK , KC_MEDIA_PLAY_PAUSE, KC_PGUP, \
