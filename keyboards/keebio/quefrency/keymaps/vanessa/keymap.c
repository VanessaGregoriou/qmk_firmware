...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |----------------------------------------------------------------|
   * |Ctrl |Fn |Win |Alt |  Space |  Space   |MN  |Ctrl  |Lef|Dow|Rig |
   * `----------------------------------------------------------------'
   */
  [_BASE] = LAYOUT_65(
    ...
    KC_LCTL, KC_LCTL, KC_LGUI, KC_LALT,KC_SPC,           KC_SPC, KC_SPC,  MO(_ML) , KC_RCTL, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
  ),
   ...
   */
  [_FL] = LAYOUT_65(
    KC_TILDE, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,  _______, \
